...
command! -nargs=* -complete=custom,s:complete_args_tool_align DMAlign let g:fgt_align = call s:Get_first_arg(<f-args>) | lua require'duckument-manners.main'.main(0, g:fgt_align)
" }}}
